...
console.log('DNS Query Result validation:', validateDNSResponse(dnsQueryResult));
...
console.log('Mismatched Query Result validation:', validateDNSResponse(mismatchedResult));
